package main.circular_linked_list.round_robin;
...
class RoundRobinScheduler {
    ...
    public void addProcess(int processId, int burstTime, int priority) {
        ...
        System.out.println("Added main.circular_linked_list.round_robin.Process ID: " + processId + ", Burst Time: " + burstTime + ", Priority: " + priority);
    }

    // Remove a process by main.circular_linked_list.round_robin.Process ID
        ...
        while (head != null) {
            ...
            do {
                if (current.burstTime > 0) {
                    ...
                    System.out.println("Executing main.circular_linked_list.round_robin.Process ID: " + current.processId + " for " + executedTime + " units.");
                    current.burstTime -= executedTime;

                    if (current.burstTime == 0) {
                        System.out.println("main.circular_linked_list.round_robin.Process ID " + current.processId + " completed.");
    ...
    public void displayProcesses() {
        ...
        Process current = head;
        do {
            System.out.println("main.circular_linked_list.round_robin.Process ID: " + current.processId + ", Burst Time: " + current.burstTime + ", Priority: " + current.priority);
            current = current.next;
        } while (current != head);
    }
}
...
public class RoundRobin{
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numProcesses; i++) {
            System.out.println("Enter main.circular_linked_list.round_robin.Process ID, Burst Time, and Priority:");
